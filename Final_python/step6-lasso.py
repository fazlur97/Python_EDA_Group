...
lasso = Lasso(alpha=0.001, max_iter=1000, random_state=41)
lasso.fit(X_train, y_train)

# Scoring on the test data
print("Score on the model: ", lasso.score(X_test, y_test))
...
model = Lasso(**best_params, random_state=41)
